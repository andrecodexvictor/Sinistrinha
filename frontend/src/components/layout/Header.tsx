    ...
    <header className="sticky top-0 z-40 w-full h-16 bg-brand-gray/95 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-4 lg:px-6 shadow-xl">
      <div className="flex items-center gap-3">
        <Link to="/" className="flex items-center gap-2 group">
          <div className="w-10 h-10 bg-brand-red rounded-lg flex items-center justify-center text-xl shadow-[0_0_15px_rgba(139,0,0,0.6)] group-hover:shadow-[0_0_25px_rgba(139,0,0,0.9)] transition-shadow">
            🦍
          </div>
